...
class MainActivity : AppCompatActivity(),NavigationView.OnNavigationItemSelectedListener{
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            R.id.nombre -> {
                Toast.makeText(this,"Elejiste perfil", Toast.LENGTH_LONG).show()

            }
            R.id.semestre -> {
                Toast.makeText(this,"Elejiste enviar mensaje", Toast.LENGTH_LONG).show()

            }
            R.id.email -> {
                Toast.makeText(this,"Elejiste llamada", Toast.LENGTH_LONG).show()

            }
            R.id.carrera -> {
                Toast.makeText(this,"Elejiste videollamada", Toast.LENGTH_LONG).show()
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            R.id.nav_home -> Toast.makeText(this, "Elgiste menu inicio", Toast.LENGTH_LONG).show()
            R.id.nav_settings -> {
